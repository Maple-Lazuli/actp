...
src_mac = "00:50:56:01:31:fe"  		# My machines mac address

src_ip = "172.16.90.3"  			# My machines ip address
dst_ip = "172.16.90.4"   		# The target machines ip address

# 1. Get MAC for dst_ip, view ARP response in WireShark
send_arp_req(dst_ip, broadcast_MAC, src_ip, src_mac)
dst_mac = "00:50:56:01:3c:98"  		# Target machine MAC address I'm poisoning
